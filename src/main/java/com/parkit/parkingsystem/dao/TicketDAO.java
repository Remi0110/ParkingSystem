...
public class TicketDAO {
    ...
    public boolean saveTicket(Ticket ticket) {
        ...
        try {
            ...
            //PARKING_NUMBER, VEHICLE_REG_NUMBER, PRICE, IN_TIME, OUT_TIME, AVAILABLE_DISCOUNT)
            ps.setInt(1,ticket.getParkingSpot().getId());
            ps.setString(2, ticket.getVehicleRegNumber());
            ps.setDouble(3, ticket.getPrice());
            ps.setTimestamp(4, Timestamp.valueOf(ticket.getInTime()));
            ps.setTimestamp(5, (ticket.getOutTime() == null)?null: Timestamp.valueOf(ticket.getOutTime()) );
            ps.setBoolean(6, ticket.isAvailableDiscount());
            return ps.execute();
        }catch (Exception ex){
    ...
    public Ticket getTicket(String vehicleRegNumber) throws Exception {
        ...
        try {
            ...
            //ID, PARKING_NUMBER, VEHICLE_REG_NUMBER, PRICE, IN_TIME, OUT_TIME, AVAILABLE_DISCOUNT)
            ...
            if(rs.next()){
                ...
                ticket.setAvailableDiscount(rs.getBoolean(6));
            }else {
            	throw new Exception();
            }            
        }catch (Exception ex){
